package com.localplatze.parisrider.Common;
...
import com.localplatze.parisrider.HomeActivity;
import com.localplatze.parisrider.Model.Adicional;
import com.localplatze.parisrider.Model.Food;
...
import com.localplatze.parisrider.R;

public class Common {

    public static Motorista currentUser;
    ...
    public static void showNotification(Context context, int id, String title, String content, Intent intent) {
        ...
        builder.setContentTitle(title)
                ...
                .setAutoCancel(true)
                .setSmallIcon(R.drawable.priderlogo)
                .setLargeIcon(BitmapFactory.decodeResource(context.getResources(), R.drawable.priderlogo));
